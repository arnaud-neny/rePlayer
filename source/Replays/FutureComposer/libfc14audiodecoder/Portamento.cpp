...
uword FC::TFMX_portamento(VoiceVars& voiceX, uword period) {
...
uword FC::COSO_portamento(VoiceVars& voiceX, uword period) {
...
uword FC::FC_portamento_pitchbend(VoiceVars& voiceX, uword period) {
