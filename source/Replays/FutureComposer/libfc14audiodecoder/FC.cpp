...
const std::string FC::FC14_TAG = "FC14";

bool FC::FC_init(int songNumber) {
    ...
    pChooseSongFunc = &FC::FC_chooseSong;
    pNextNoteFunc = &FC::FC_nextNote;
    pSoundFunc = &FC::TFMX_soundModulation;
    pVibratoFunc = &FC::TFMX_vibrato;
    pPortamentoFunc = &FC::FC_portamento_pitchbend;
    ...
    TFMX_sndModFuncs[5] = &FC::TFMX_sndSeq_UNDEF;
    TFMX_sndModFuncs[6] = &FC::TFMX_sndSeq_UNDEF;
    TFMX_sndModFuncs[7] = &FC::TFMX_sndSeq_E7;
    TFMX_sndModFuncs[9] = &FC::FC_sndSeq_E9;
    TFMX_sndModFuncs[10] = &FC::FC_sndSeq_EA_pitchbend;

    // At +32 is module offset to start of samples.
    udword sampleOffset = readBEudword(fcBuf,32);
    udword sampleHeader = SMOD_SMPHEADERS_OFFSET;  // unchanged in FC14
...
void FC::FC_chooseSong(ubyte song) {
...
void FC::FC_nextNote(VoiceVars& voiceX) {
