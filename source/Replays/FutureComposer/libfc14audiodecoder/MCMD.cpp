...
const std::string FC::MCMD_FORMAT_NAME = "MCMD (AMIGA)";
const std::string FC::MCMD_TAG = "MCMD";

bool FC::MCMD_init(int songNumber) {
    ...
    pChooseSongFunc = &FC::MCMD_chooseSong;
    ...
    TFMX_sndModFuncs[5] = &FC::TFMX_sndSeq_E7_setDiffWave;
    TFMX_sndModFuncs[6] = TFMX_sndModFuncs[9] =
        TFMX_sndModFuncs[10] = &FC::TFMX_sndSeq_UNDEF;
...
void FC::MCMD_chooseSong(ubyte song) {
