...
void FC::setInstrument(VoiceVars& voiceX, ubyte instr) {
...
void FC::setWave(VoiceVars& voiceX, ubyte num) {
...
void FC::TFMX_soundModulation(VoiceVars& voiceX) {
    admin.readModRecurse = 0;
    vModFunc.clear();
    vModFunc.push_back( &FC::TFMX_processSndModSustain );
...
void FC::TFMX_processSndModSustain(VoiceVars& voiceX) {
    if (voiceX.sndModSustainTime == 0) {
        vModFunc.push_back( &FC::TFMX_processSndModSeq );
    }
    else {
        --voiceX.sndModSustainTime;
        if (traits.skipToWaveMod) {  // some player versions
            vModFunc.push_back( &FC::TFMX_waveModulation );
        }
    }
}

void FC::TFMX_processSndModSeq(VoiceVars& voiceX) {
    ...
    if (f<0xe0) {
        vModFunc.push_back( &FC::TFMX_waveModulation );
        vModFunc.push_back( &FC::TFMX_sndSeqTrans );
    }
    else if (f<0xeb) {
...
void FC::TFMX_sndSeq_UNDEF(VoiceVars& voiceX) {
...
void FC::TFMX_sndSeq_E0(VoiceVars& voiceX) {  // loop
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
    voiceX.sndSeqPos = fcBuf[seqOffs++]&0x3f;
    vModFunc.push_back( &FC::TFMX_processSndModSeq );
}

void FC::TFMX_sndSeq_E1(VoiceVars& voiceX) {  // end
    // basically NOP
}

void FC::TFMX_sndSeq_E1_waveMod(VoiceVars& voiceX) {
    vModFunc.push_back( &FC::TFMX_waveModulation );
}

void FC::TFMX_sndSeq_E2(VoiceVars& voiceX) {  // set wave
...
void FC::TFMX_sndSeq_E3(VoiceVars& voiceX) {  // set vibrato
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
    voiceX.vibSpeed = fcBuf[seqOffs++];
...
void FC::TFMX_sndSeq_E4(VoiceVars& voiceX) {  // new wave
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
    setWave(voiceX,fcBuf[seqOffs++]);
...
void FC::TFMX_sndSeq_E5_repOffs(VoiceVars& voiceX) {
    prepareChannelUpdate(voiceX);
...
void FC::TFMX_sndSeq_E5(VoiceVars& voiceX) {
    voiceX.volRandomThreshold = 0;
    prepareChannelUpdate(voiceX);
...
void FC::TFMX_sndSeq_E6(VoiceVars& voiceX) {
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
    uword p1 = fcBuf[seqOffs++];
    p1 <<= 8;
    p1 |= fcBuf[seqOffs++];
...
void FC::TFMX_sndSeq_E7(VoiceVars& voiceX) {  // set seq
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
...
void FC::TFMX_sndSeq_E7_setDiffWave(VoiceVars& voiceX) {
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
    ubyte s = fcBuf[seqOffs++];
...
void FC::TFMX_sndSeq_E8(VoiceVars& voiceX) {  // set sustain
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
...
void FC::TFMX_sndSeq_E9(VoiceVars& voiceX) {
    voiceX.volRandomThreshold = 0;
    voiceX.currentWave = 0xff;
    prepareChannelUpdate(voiceX);
...
void FC::TFMX_sndSeq_EA_skip(VoiceVars& voiceX) {  // NOP + skip
    voiceX.sndSeqPos += 2;
}

void FC::TFMX_sndSeq_EA(VoiceVars& voiceX) {  // volume randomization
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
...
void FC::TFMX_sndSeqTrans(VoiceVars& voiceX) {
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos;
...
void FC::TFMX_waveModulation(VoiceVars& voiceX) {
...
void FC::TFMX_processPerVol(VoiceVars& voiceX) {
...
void FC::FC_sndSeq_E9(VoiceVars& voiceX) {
    voiceX.volRandomThreshold = 0;
    voiceX.currentWave = 0xff;
    prepareChannelUpdate(voiceX);
...
void FC::FC_sndSeq_EA_pitchbend(VoiceVars& voiceX) {  // FC modification
    udword seqOffs = voiceX.sndSeq+voiceX.sndSeqPos+1;
