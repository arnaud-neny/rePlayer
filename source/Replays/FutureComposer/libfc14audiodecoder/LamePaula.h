...
class LamePaulaMixer : public PaulaMixer
{
 public:
    ...
    void EnableNtsc(bool isEnabled) { AMIGA_CLOCK = isEnabled ? AMIGA_CLOCK_NTSC : AMIGA_CLOCK_PAL; }

    udword fillBuffer(void* buffer, udword bufferLen, PaulaPlayer *player);
