/*
 * libopenmpt_stream_callbacks_file_posix.h
 * ----------------------------------------
...
#ifndef LIBOPENMPT_STREAM_CALLBACKS_FILE_POSIX_H
#define LIBOPENMPT_STREAM_CALLBACKS_FILE_POSIX_H
...
static openmpt_stream_callbacks openmpt_stream_get_file_posix_callbacks(void) {
	...
	retval.read = openmpt_stream_file_posix_read_func;
	retval.seek = openmpt_stream_file_posix_seek_func;
	retval.tell = openmpt_stream_file_posix_tell_func;
	return retval;
}
...
#endif /* LIBOPENMPT_STREAM_CALLBACKS_FILE_POSIX_H */
