/*
 * libopenmpt_stream_callbacks_file_posix_lfs64.h
 * ----------------------------------------------
...
#ifndef LIBOPENMPT_STREAM_CALLBACKS_FILE_POSIX_LFS64_H
#define LIBOPENMPT_STREAM_CALLBACKS_FILE_POSIX_LFS64_H
...
static openmpt_stream_callbacks openmpt_stream_get_file_posix_lfs64_callbacks(void) {
	...
	retval.read = openmpt_stream_file_posix_lfs64_read_func;
	retval.seek = openmpt_stream_file_posix_lfs64_seek_func;
	retval.tell = openmpt_stream_file_posix_lfs64_tell_func;
	return retval;
}
...
#endif /* LIBOPENMPT_STREAM_CALLBACKS_FILE_POSIX_LFS64_H */
