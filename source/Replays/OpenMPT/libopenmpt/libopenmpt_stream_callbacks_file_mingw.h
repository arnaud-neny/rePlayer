...
#define LIBOPENMPT_STREAM_CALLBACKS_FILE_MINGW_H
...
static openmpt_stream_callbacks openmpt_stream_get_file_mingw_callbacks(void) {
	...
	retval.read = openmpt_stream_file_mingw_read_func;
	retval.seek = openmpt_stream_file_mingw_seek_func;
	retval.tell = openmpt_stream_file_mingw_tell_func;
	return retval;
}
...
#endif /* LIBOPENMPT_STREAM_CALLBACKS_FILE_MINGW_H */
