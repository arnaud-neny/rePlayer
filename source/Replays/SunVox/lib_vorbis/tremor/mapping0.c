...
void mapping_clear_info(tremor_vorbis_info_mapping *info){
  if(info){
...
int mapping_info_unpack(tremor_vorbis_info_mapping *info,tremor_vorbis_info *vi,
...
int mapping_inverse(tremor_vorbis_dsp_state *vd,tremor_vorbis_info_mapping *info){
