...
size_t bwrite(const void*, size_t, size_t, mem_out*);
void bclose(mem_out*);
static inline void write8	(mem_out*f, uint8 b) {
	bwrite(&b, 1, 1, f);
}

void	write16l		(mem_out *, uint16);
void	write16b		(mem_out *, uint16);
void	write32l		(mem_out *, uint32);
void	write32b		(mem_out *, uint32);
// rePlayer end
