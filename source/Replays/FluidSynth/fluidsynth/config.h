...
#define TEST_SOUNDFONT ""

/* DLS to load for unit testing */
#define TEST_DLS ""

/* Soundfont to load for UTF-8 unit testing */
#define TEST_SOUNDFONT_UTF8_1 ""
#define TEST_SOUNDFONT_UTF8_2 ""
#define TEST_MIDI_UTF8 ""
#define TEST_WAV_UTF8 ""

/* SF3 Soundfont to load for unit testing */
#define TEST_SOUNDFONT_SF3 ""

/* Command lines to use for shell parse unit testing */
#define TEST_COMMAND_LINES ""
