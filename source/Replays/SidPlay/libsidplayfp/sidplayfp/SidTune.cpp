...
SidTune::SidTune(const char* fileName, const char **fileNameExt, bool separatorIsSlash) :
    SidTune(nullptr, nullptr, fileName, fileNameExt, separatorIsSlash)
{
}

SidTune::SidTune(LoaderFunc loader, void* loaderData, const char* fileName, const char **fileNameExt, bool separatorIsSlash) :
    tune(nullptr)
{
    setFileNameExtensions(fileNameExt);
    load(loader, loaderData, fileName, separatorIsSlash);
}
...
{
    load(nullptr, nullptr, fileName, separatorIsSlash);
}

void SidTune::load(LoaderFunc loader, void* loaderData, const char* fileName, bool separatorIsSlash)
{
    try
    {
        delete tune;
        tune = SidTuneBase::load(loader, loaderData, fileName, fileNameExtensions, separatorIsSlash);
        m_status = true;
