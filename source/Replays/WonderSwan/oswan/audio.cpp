...
void ws_audio_set_channels_pbuf(int address, int data);

void ws_audio_process_noise(int count);
void ws_audio_process_sweep(int count);
BYTE ws_audio_process_voice(int count);
void ws_audio_process_hyper_voice(int count, BYTE* hvoice_l, BYTE* hvoice_r);
void WsWaveSet(BYTE voice, BYTE hvoice_l, BYTE hvoice_r);
