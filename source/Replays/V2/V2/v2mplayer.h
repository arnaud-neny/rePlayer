...
public:
    ...
    V2MPlayer(bool useCore = true, uint32_t a_tickspersec = 1000);
    ~V2MPlayer();
  ...
  // returns if song is currently playing
    ...
    bool IsCoreSynth() const { return m_synth != nullptr; }
...
private:
    ...
    V2::SynthAsm* m_asmSynth{ nullptr };

    // \o/
    uint8_t* m_synth{ nullptr };
