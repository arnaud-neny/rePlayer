...
namespace rePlayer
{
    ReplayPlugin g_replayPlugin = {
        ...
        .settings = "Unix Amiga Delitracker Emulator 3.0.5",
    ...
    void ReplayUADE::BuildMediaType()
    {
        if (m_mediaType.ext == eExtension::Unknown)
        {
            ...
            {
                static const char* const extensionNames[] = { "emsv6", "TFMX7V", "TFMX1.5", "sa_old", "aon8", "mod15" };
                static eExtension extensions[] = { eExtension::_ems, eExtension::_mdat, eExtension::_mdat, eExtension::_sa, eExtension::_aon, eExtension::_stk };
