...
/*
 * Create a string from C string by copying the content, i.e. the original
 * string will remain unchanged even if the returned string is modified.
 * Note: bencode string always ends with '\0'. Use ben_blob() if multiple
 *       '\0' can be part of the byte sequence.
 */
