...
@git diff --no-index external/imgui-docking/imgui.cpp source/Core/ImGui/imgui.cpp >> source/Core/ImGui/imgui.diff
@git diff --no-index external/imgui-docking/imgui_internal.h source/Core/ImGui/imgui_internal.h >> source/Core/ImGui/imgui.diff
